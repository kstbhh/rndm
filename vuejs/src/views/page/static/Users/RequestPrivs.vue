                  ...
                  <div class="columns is-multiline is-desktop">
                    ...
                    <div class="column is-full has-text-left">
                      <ul>
                        ...
                        <li class="has-text-black"> Invite New Users through Stormbreaker Mail Service.</li>
                      </ul>
                    </div>
                    <div class="column is-full">
              ...
              <div class="field">
                <div class="control">
                  <div class="b-checkbox is-success is-circular is-inline">
                    ...
                    <label for="terms">
                      <span class="content has-text-white">  I Accept and Read the <a class="has-text-success" href="https://raw.githubusercontent.com/kstbhh/rndm/dark-mode-0-1/CONTRIBUTING.md" target="_blank">Community Guidelines</a></span>
                    </label>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  <div class="b-checkbox is-success is-circular is-inline">
                    ...
                    <label for="code">
                      <span class="content has-text-white">  I Accept and Read the <a class="has-text-success" href="https://github.com/kstbhh/rndm/blob/dark-mode-0-1/CODE_OF_CONDUCT.md" target="_blank">Code of Conduct</a></span>
                    </label>
                  </div>
                </div>
              </div>
                      ...
                      <div class="columns is-multiline is-desktop">
                        ...
                        <div class="column is-full">
                          <ul>
                            ...
                            <li> Invite a Admin for Superadmin Role throught Stormbreaker mail Service</li>
                            <li> Invite a user for Admin Role throught Stormbreaker mail Service</li>
                          </ul>
                        </div>
                        <div class="column is-full">
